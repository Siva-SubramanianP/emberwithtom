...
define("frontend/tests/unit/routes/add-test", ["qunit", "frontend/tests/helpers"], function (_qunit, _helpers) {
  "use strict";
...
define("frontend/tests/unit/routes/write-test", ["qunit", "frontend/tests/helpers"], function (_qunit, _helpers) {
  "use strict";

  0; //eaimeta@70e063a35619d71f0,"qunit",0,"frontend/tests/helpers"eaimeta@70e063a35619d71f
  (0, _qunit.module)('Unit | Route | write', function (hooks) {
    (0, _helpers.setupTest)(hooks);
    (0, _qunit.test)('it exists', function (assert) {
      let route = this.owner.lookup('route:write');
      assert.ok(route);
    });
  });
});
